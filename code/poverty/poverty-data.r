...
#Import poverty data
pov = brooks::load_https("https://raw.github.com/wesesque/gwr/tree/master/data/poverty/upMidWestpov_Iowa_cluster_names.csv", header=TRUE, header=TRUE, sep=",", rownames=FALSE)
