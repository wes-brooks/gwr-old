library(sp, lib.loc=c('R', 'R-libs/i386-redhat-linux-gnu-library/2.15'))
library(shapefiles, lib.loc=c('R', 'R-libs/i386-redhat-linux-gnu-library/2.15'))
library(plotrix, lib.loc=c('R', 'R-libs/i386-redhat-linux-gnu-library/2.15'))
library(ggplot2, lib.loc=c('R', 'R-libs/i386-redhat-linux-gnu-library/2.15'))
library(RandomFields, lib.loc=c('R', 'R-libs/i386-redhat-linux-gnu-library/2.15'))
library(scales, lib.loc=c('R', 'R-libs/i386-redhat-linux-gnu-library/2.15'))

library(foreach, lib.loc=c('R', 'R-libs/i386-redhat-linux-gnu-library/2.15'))
library(iterators, lib.loc=c('R', 'R-libs/i386-redhat-linux-gnu-library/2.15'))
library(multicore, lib.loc=c('R', 'R-libs/i386-redhat-linux-gnu-library/2.15'))
library(doMC, lib.loc=c('R', 'R-libs/i386-redhat-linux-gnu-library/2.15'))

library(lars, lib.loc=c('R', 'R-libs/i386-redhat-linux-gnu-library/2.15'))
library(glmnet, lib.loc=c('R', 'R-libs/i386-redhat-linux-gnu-library/2.15'))
library(gwselect, lib.loc=c('R', 'R-libs/i386-redhat-linux-gnu-library/2.15'))

library(splancs, lib.loc=c('R', 'R-libs/i386-redhat-linux-gnu-library/2.15'))
library(geoR, lib.loc=c('R', 'R-libs/i386-redhat-linux-gnu-library/2.15'))
library(maptools, lib.loc=c('R', 'R-libs/i386-redhat-linux-gnu-library/2.15'))
library(spgwr, lib.loc=c('R', 'R-libs/i386-redhat-linux-gnu-library/2.15'))
