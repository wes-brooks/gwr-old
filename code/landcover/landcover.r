...
bw = gwglmnet.nen.sel(Cover1987~Own+Res+PolyNm+PolyPr+MxPolyPr+TotOwn+AvParcel, data=landcover05, coords=landcover05[,c('X','Y')], weights=weights, gweight=bisquare, s=seq(0,5,0.001), tol=10, type='pearson', family='binomial', parallel=TRUE)
