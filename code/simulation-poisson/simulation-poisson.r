...
bw.glmnet = gwglmnet.sel(Y~X1+X2+X3+X4+X5-1, data=sim, family='poisson', alpha=1, coords=sim[,c('loc.x','loc.y')], longlat=FALSE, mode.select='AICc', gweight=spherical, tol.bw=0.01, bw.method='knn', adapt=TRUE, precondition=FALSE, parallel=FALSE, interact=FALSE, verbose=TRUE, shrunk.fit=TRUE, bw.select='AICc', resid.type='pearson')
model.glmnet = gwglmnet(Y~X1+X2+X3+X4+X5-1, data=sim, family='poisson', alpha=1, coords=sim[,c('loc.x','loc.y')], longlat=FALSE, N=1, mode.select='AICc', bw=bw.glmnet[['bw']], gweight=spherical, bw.method='knn', simulation=TRUE, adapt=TRUE, precondition=FALSE, parallel=FALSE, interact=FALSE, verbose=TRUE, shrunk.fit=TRUE)

bw.enet = gwglmnet.sel(Y~X1+X2+X3+X4+X5-1, data=sim, family='poisson', alpha='adaptive', coords=sim[,c('loc.x','loc.y')], longlat=FALSE, mode.select='AICc', gweight=spherical, tol.bw=0.01, bw.method='knn', adapt=TRUE, precondition=FALSE, parallel=FALSE, interact=FALSE, verbose=TRUE, shrunk.fit=TRUE, bw.select='AICc', resid.type='pearson')
model.enet = gwglmnet(Y~X1+X2+X3+X4+X5-1, data=sim, family='poisson', alpha='adaptive', coords=sim[,c('loc.x','loc.y')], longlat=FALSE, N=1, mode.select='AICc', bw=bw.enet[['bw']], gweight=spherical, bw.method='knn', simulation=TRUE, adapt=TRUE, precondition=FALSE, parallel=FALSE, interact=FALSE, verbose=TRUE, shrunk.fit=TRUE)
