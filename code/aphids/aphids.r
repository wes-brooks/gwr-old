...
bw = gwglmnet.nen.sel(count~Corn + soybeans + S_Grains + All_Grasslands + Forests_All + Water + Developed + Wetlands, data=aphids06, coords=aphids06[,c('Longitude','Latitude')], weights=weights, gweight=bisquare, s=NULL, method='nen', tol=1, family='poisson', parallel=TRUE, longlat=TRUE)
