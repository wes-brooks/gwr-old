...
\section{Simulation}
	...
	%As a baseline, ordinary GWR was used to estimate the coefficients using the same data but under an ``oracle" setting (O-GWR), meaning that GWR was provided with the exactly correct set of predictors as used in the data-generating process. The ratio of the coverage frequency of the GWL to the coverage frequency of O-GWR is called the relative efficiency of the GWL.\\
