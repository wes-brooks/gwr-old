...
\begin{frame}{Introduction}
\subt{Spatial linear regression \citep{Cressie:1993}}
...
\begin{frame}{Introduction}
\subt{Spatially varying coefficient model \citep{Gelfand:2003}}
...
\begin{frame}{Introduction}
\subt{Varying coefficients regression (VCR) \citep{Hastie:1993a}}
