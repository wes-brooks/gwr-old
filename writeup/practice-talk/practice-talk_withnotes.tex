...
% title info
\title{Variable selection and parameter estimation for spatially varying coefficient models}
...
\date{\href{http://www.somesquareas.org}{\tt \scriptsize somesquares.org}}
