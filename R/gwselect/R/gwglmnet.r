gwglmnet <- function(formula, data, family, weights=NULL, coords, fit.loc=NULL, indx=NULL, tuning=FALSE, predict=FALSE, simulation=FALSE, gweight, bw=NULL, mode.select='AIC', verbose=FALSE, longlat, tol, N=1, method, adapt=FALSE, s=NULL, parallel=FALSE, precondition=FALSE, D=NULL, oracle=NULL, interact=FALSE, alpha=1, shrunk.fit=TRUE, AICc=FALSE) {
    if (!is.logical(adapt)) 
