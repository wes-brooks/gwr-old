gwglmnet.fit.nen = function(x, y, family, coords, D, s, mode.select, verbose, prior.weights, gweight, target, beta1, beta2, tol=1e-25, longlat=FALSE, adapt, precondition=FALSE, tuning, simulation, predict, N, interact, alpha, AICc) {
    ...
    for (i in 1:n) {
        ...
        opt = optimize(gwglmnet.ssr, lower=beta1, upper=beta2, 
            ...
            prior.weights=prior.weights, target=target, precondition=precondition, AICc=AICc)
