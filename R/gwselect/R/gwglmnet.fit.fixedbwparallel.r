gwglmnet.fit.fixedbwparallel = function(x, y, family, coords, fit.loc=NULL, indx=NULL, bw, D=NULL, s=NULL, oracle, verbose=FALSE, mode.select, gwr.weights=NULL, prior.weights=NULL, gweight=NULL, longlat, adapt, precondition, alpha, simulation, tuning, predict, interact, N) {
    if (!is.null(fit.loc)) {
