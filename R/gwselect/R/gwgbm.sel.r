gwgbm.sel = function(formula, data=list(), family, weights=NULL, range=NULL, coords, adapt=FALSE, gweight=gwr.Gauss, s, method="dist", verbose=FALSE, longlat=FALSE, tol=.Machine$double.eps^0.25, parallel=FALSE, precondition=FALSE) {
    if (!is.logical(adapt)) 
